...
<div class="container">
  ...
  <div class="col-7">
    <img src="../dashboard/uploads/image.jpg" height="110">
  </div>
       
      </div>
      <div class="col-5">
        <h1 class="document-type display-4">HISTORIQUE</h1>
    ...
    $sql2 = "SELECT * FROM `medecin` WHERE id = ".$row['idmedecin'];
