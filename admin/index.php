...
<div class="app-container">
  <div class="app-header">
    ...
    <div class="app-header-right">
      ...
      <button class="profile-btn">
        <img src="../dashboard/uploads/admin.png" />
        <span><?php echo $nom; ?><?php echo "| Solde : ".$solde." DT"; ?></span>
      </button>
    </div>
  ...
  <div class="app-content">
    <div class="app-sidebar">
      ...
      <a href="historique.php" class="app-sidebar-link active">
        <img src="history.png" width="30">
      </a>
    ...
    <div class="projects-section">
      ...
      <form name="f" method="post" action="insert.php" enctype="multipart/form-data">
      ...
      <div class="corps-formulaire">
        <div class="gauche">
          ...
          <div class="groupe">
            ...
            <input type="text" name="specialiter" autocomplete="off" />
            <i class="fas fa-mobile"></i>
          </div>

          <div class="groupe">
            <label>frais de visite</label>
            <input type="text" name="solde"name="sold" />
            <i class="fas fa-mobile"></i>
          </div>
        </div>
      ...
      <div class="pied-formulaire" align="center">
        <button type="submit" name="create" >Enregister</button>
      </div>
    </form>
    ...
    ?>
        ...
        <div class="project-box-content-header">
          <p class="box-content-header"><img src="../dashboard/uploads/<?php echo $row['image']; ?>" width="100" heigth="200"></p>
          <p class="box-content-subheader"><?php echo $row['specialiter']; ?></p>
        </div>
       
        <div class="project-box-footer">
          <div class="participants">
            
            <a href="supprimer.php?idmed=<?php echo $row['id']; ?>"><button  class="days-left" style="color: #ff942e;">
             supprimer
            </button></a>
          </div>
