  ...
  <div class="app-content">
    ...
    ?>
        ...
        <div class="project-box-content-header">
          <p class="box-content-header"><img src="uploads/<?php echo $row['image']; ?>" width="100" heigth="200"></p>
        ...
        <div class="project-box-footer">
          <div class="participants">
            ...
            <a href="facture.php?idmed=<?php echo $row['id']; ?>"><button  class="days-left" style="color: #ff942e;">
              passe un rendez-vous
            </button></a>
          </div>
...
<div class="messages-section">
  ...
  <div class="messages"> 
   ...
   <?php $sql = "SELECT * FROM `rendevouz` where idclient = ".$_SESSION['id']." and date <= now() order by `date`";
    $result = mysqli_query($conn, $sql);
    while($row = mysqli_fetch_assoc($result)){
    
    $sql1 = "SELECT * FROM `medecin` where id = ".$row['idmedecin'];
    ...
    <div class="message-box">
      <img src="uploads/<?php echo $row1['image']; ?>" alt="profile image">
      <div class="message-content">
        <div class="message-header">
          <div class="name"><?php echo $row1['nom']; ?></div>

        </div>
        <p class="message-line">
         specialiter : <?php echo $row1['specialiter']; ?>
